...
pub struct ModelParameters {
    ...
    /// The arguments to pass to the [custom RoPE](https://arxiv.org/pdf/2306.15595.pdf) function, if it is used by the model.
    pub rope_arguments: Option<ggml::CustomRoPEArguments>,
}
