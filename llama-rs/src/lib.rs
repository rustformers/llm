...
pub struct InferenceSession {
    ...
    /// The number of tokens considered during repetition penalization in sampling
...
impl InferenceSession {
    fn repetition_penalty_tokens(&self) -> &[TokenId] {
        &self.tokens[self
            .tokens
            .len()
            .saturating_sub(self.repetition_penalty_last_n)..]
    }
}
...
impl<'a> OutputToken<'a> {
    fn from_id(vocab: &'a Vocabulary, id: TokenId) -> Self {
        if id == 2 {
            ...
            Self::Token(&vocab.mapping[id as usize])
        }
    }
}
...
pub enum SnapshotError {
    ...
    #[error(
        "could not write snapshot due to size mismatch (self={self_size}, input={input_size})"
    )]
...
impl Model {
    ...
    pub fn start_session(&self, last_n_size: usize) -> InferenceSession {
        ...
        InferenceSession {
            ...
            n_past: 0,
            mem_per_token: 0,
            repetition_penalty_last_n: last_n_size,
            tokens: vec![],
    ...
    pub fn session_from_snapshot(
        ...
        let mut session = self.start_session(snapshot.repetition_penalty_last_n);
...
impl InferenceSession {
    ...
    pub fn infer_next_token<'v>(
        ...
        Ok(OutputToken::from_id(vocab, next_token))
    }
